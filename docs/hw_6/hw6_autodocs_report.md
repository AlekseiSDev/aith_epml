...
Настроенная посадочная страница MkDocs с навигацией по всем HW и API Reference.
![Главная страница документации](hw6_1.jpg)

**Автоматически сгенерированный API Reference**  
Пример страницы API, созданной на основе docstrings модулей проекта с помощью плагина `mkdocstrings`.
![Автоматически сгенерированный API Reference](hw6_2.png)

**Процесс публикации через GitHub Actions**  
Успешное выполнение CI/CD пайплайна (сборка и деплой) при пуше изменений.
![Процесс публикации через GitHub Actions](hw6_3.png)
